  ...
  return (
    ...
    <div className="search-cover mt-4">
       <div className="search-properties">
        <form action="" className='d-flex align-items-center' onSubmit={handleSearch} id='form1'>
         <div className="search-location">
            <span className='discoverfind'>LOCATION</span>
            <input type='text' placeholder='eg. Lagos' value={loc} onChange={(e)=>setLoc(e.target.value)} />
         </div>
         ...
         <div className="search-location">
            ...
            <input type='text' placeholder='eg. land, house' value={spec} onChange={(e)=>setSpec(e.target.value)} />
         </div>
       ...
       <button id='form1'  type='submit' className='userBtn'>Find Property</button>
         </form>
       </div>
    </div>
</div>
